...
insert into paypal_account values ( 1, 100000, 100000, 0, 111);
insert into paypal_account values ( 2, 40000, 40000, 0, 222);
insert into paypal_account values ( 3, 4000, 4000, 0, 333);
insert into paypal_account values ( 4, 4000, 4000, 0, 444);
insert into paypal_account values ( 5, 4000, 4000, 0, 555);
--
insert into product values (1,    to_date('07-12-20','dd-mm-yy')    ,to_date('17-12-20','dd-mm-yy'),    3    ,'A',    'N',    3,  'N',    'N',    'N',    'N',    'N', 'N', 'Charles',  30,    111);
insert into product values (2,    to_date('08-12-20','dd-mm-yy')    ,to_date('18-12-20','dd-mm-yy'),    3    ,'B',    'N',    3,  'N',    'N',    'N',    'N',    'N', 'N', 'Ali',   30,    222);
insert into product values (3,    to_date('07-12-20','dd-mm-yy')    ,to_date('19-12-20','dd-mm-yy'),    3    ,'C',    'N',    3,  'N',    'N',    'N',    'N',    'N', 'N', 'Mary',    30,    333);
insert into product values (4,    to_date('10-12-20','dd-mm-yy')    ,to_date('20-12-20','dd-mm-yy'),    3    ,'D',    'N',    3,  'N',    'N',    'N',    'N',    'N', 'N', 'Halian',   30,    444);
insert into product values (5,    to_date('11-12-20','dd-mm-yy')    ,to_date('21-12-20','dd-mm-yy'),    3    ,'E',    'N',    3,  'N',    'N',    'N',    'N',    'N', 'N', 'Habtu',   30,    555);
