...
insert into product values (7,    to_date('13-12-20','dd-mm-yy')    ,to_date('23-12-20','dd-mm-yy'),    30000    ,'G',    'N',    'N',    'N',    'N',    300000,    5);
insert into product values (8,    to_date('14-12-20','dd-mm-yy')    ,to_date('24-12-20','dd-mm-yy'),    30000    ,'H',    'N',    'N',    'N',    'N',    300000,    6);
insert into product values (9,    to_date('15-12-20','dd-mm-yy')    ,to_date('25-12-20','dd-mm-yy'),    30000    ,'I',    'N',    'N',    'N',    'N',    300000,    1);
insert into product values (10,    to_date('16-12-20','dd-mm-yy')    ,to_date('26-12-20','dd-mm-yy'),    30000    ,'J',    'N',    'N',    'N',    'N',    300000,    2);
