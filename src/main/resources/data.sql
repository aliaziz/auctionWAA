...
insert into product values (1,    to_date('07-12-20','dd-mm-yy')    ,to_date('17-12-20','dd-mm-yy'),    3    ,'A',    'N',    'N',    'N',    'N', 'N', 'Charles',  30,    1);
insert into product values (2,    to_date('08-12-20','dd-mm-yy')    ,to_date('18-12-20','dd-mm-yy'),    3    ,'B',    'N',    'N',    'N',    'N', 'N', 'Ali',   30,    2);
insert into product values (3,    to_date('07-12-20','dd-mm-yy')    ,to_date('19-12-20','dd-mm-yy'),    3    ,'C',    'N',    'N',    'N',    'N', 'N', 'Mary',    30,    5);
insert into product values (4,    to_date('10-12-20','dd-mm-yy')    ,to_date('20-12-20','dd-mm-yy'),    3    ,'D',    'N',    'N',    'N',    'N', 'N', 'Halian',   30,    6);
insert into product values (5,    to_date('11-12-20','dd-mm-yy')    ,to_date('21-12-20','dd-mm-yy'),    3    ,'E',    'N',    'N',    'N',    'N', 'N', 'Habtu',   30,    1);
insert into product values (6,    to_date('12-12-20','dd-mm-yy')    ,to_date('22-12-20','dd-mm-yy'),    3    ,'F',    'N',    'N',    'N',    'N', 'N', 'Charles',   30,    2);
insert into product values (7,    to_date('13-12-20','dd-mm-yy')    ,to_date('23-12-20','dd-mm-yy'),    3    ,'G',    'N',    'N',    'N',    'N', 'N',  'Ali',  30,    5);
insert into product values (8,    to_date('14-12-20','dd-mm-yy')    ,to_date('24-12-20','dd-mm-yy'),    3    ,'H',    'N',    'N',    'N',    'N', 'N',  'Mary', 30,    6);
insert into product values (9,    to_date('15-12-20','dd-mm-yy')    ,to_date('25-12-20','dd-mm-yy'),    3    ,'I',    'N',    'N',    'N',    'N', 'N',  'Halian', 30,    1);
insert into product values (10,    to_date('16-12-20','dd-mm-yy')    ,to_date('26-12-20','dd-mm-yy'),   3    ,'J',    'N',    'N',    'N',    'N', 'N',  'Habtu',  30,    2);
